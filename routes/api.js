...
router.get("/promo", (req, res) => {
  res.status(200).send({title: "We are working to fix the secondary currency, sorry for the inconvenience", url: "https://www.portfolioview.ca/issue", showDeviceId: false})
})
